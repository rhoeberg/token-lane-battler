...
SHAPES_TEXTURE_RECT :: Rect {65, 0, 10, 10}
...
atlas_textures: [Texture_Name]Atlas_Texture = {
	.None = {},
	.Test_Face = { rect = {33, 0, 31, 32}, offset_top = 0, offset_right = 1, offset_bottom = 0, offset_left = 0, document_size = {32, 32}, duration = 0.100},
