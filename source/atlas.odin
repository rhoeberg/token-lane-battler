...
SHAPES_TEXTURE_RECT :: Rect {221, 0, 10, 10}
...
atlas_textures: [Texture_Name]Atlas_Texture = {
	...
	.Healer = { rect = {129, 0, 24, 30}, offset_top = 1, offset_right = 4, offset_bottom = 1, offset_left = 4, document_size = {32, 32}, duration = 0.100},
	.Rats = { rect = {167, 0, 26, 27}, offset_top = 5, offset_right = 0, offset_bottom = 0, offset_left = 6, document_size = {32, 32}, duration = 0.100},
	.Test_Face = { rect = {66, 0, 31, 32}, offset_top = 0, offset_right = 1, offset_bottom = 0, offset_left = 0, document_size = {32, 32}, duration = 0.100},
	.Bannerman = { rect = {194, 0, 26, 24}, offset_top = 8, offset_right = 1, offset_bottom = 0, offset_left = 5, document_size = {32, 32}, duration = 0.100},
	.Spearman = { rect = {154, 0, 12, 30}, offset_top = 2, offset_right = 10, offset_bottom = 0, offset_left = 10, document_size = {32, 32}, duration = 0.100},
	.Slug = { rect = {98, 0, 30, 30}, offset_top = 2, offset_right = 0, offset_bottom = 0, offset_left = 2, document_size = {32, 32}, duration = 0.100},
}
